package where.$2_system_logic.$3_on_mapper.mapper.table

import where.$2_system_logic.$3_on_mapper.domain.ContractId
import where.$2_system_logic.$3_on_mapper.mapper.{Arrears, ConfirmDate, EndDate, StartDate}
